...
##### 나. 디코딩
모델 $$\Theta$$가 주어진 상황에서, 관측벡터 $$O$$를 얻었을때 최적의 상태열은?


##### 다. 학습
훈련집합 $$X={O1,..,ON}$$이 주어져 있을때 HMM의 매개 변수 $$\Theta$$는?
